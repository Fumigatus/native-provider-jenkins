# ====================================================================================
# Setup Project
PROJECT_NAME := provider-nativeproviderjenkins
...
IMAGES = provider-nativeproviderjenkins
...
XPKGS = provider-nativeproviderjenkins
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-nativeproviderjenkins: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider NativeProviderJenkins CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider NativeProviderJenkins controllers
...
# This target prepares repo for your provider by replacing all "nativeproviderjenkins"
